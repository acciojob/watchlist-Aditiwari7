...
public class MovieController {
    ...
    public ResponseEntity<Movie> getMovieByName(@PathVariable String name){
        Movie resultMovie = movieService.MovieByNames(name);
        return new ResponseEntity<>(resultMovie, HttpStatus.CREATED);
    }

    @GetMapping("/get-director-by-name/{name}")
    public ResponseEntity<Director> getDirectorByName(@PathVariable String name){
        Director resultDirector = movieService.getDirectorNames(name);
    ...
    public ResponseEntity<List<String>> findAllMovies(){
        List<String> resultDirector = movieService.findAllMovies();
        return new ResponseEntity<>(resultDirector, HttpStatus.CREATED);
    }
